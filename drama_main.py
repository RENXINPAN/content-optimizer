...
3. 画面风格必须统一：梵高油画风格，厚重笔触、旋涡纹理、富有表现力的色彩
4. 画面要配合文案的情绪，但不要照字面画（比如文案说"你困了就睡"不要真画一个人睡觉）
5. 画面应该是意境性的、氛围感的场景
6. 画面的色调、天气、场景、人物必须根据对应文案的情绪和内容来决定（比如：悲伤→雨天灰蓝色调，夜晚→深蓝星空，回忆童年→出现小孩，温暖→金黄暖光，孤独→空旷场景单一人影）

## Flux 提示词要求（极其重要）
每个镜头的 flux_prompt 末尾必须包含这段统一风格描述：
"Van Gogh inspired oil painting style, thick impasto brushstrokes, swirling textured sky, expressive post-impressionist painting, rich oil paint layers and visible brush texture, dreamy poetic atmosphere, vertical 16:9 composition, masterpiece quality"
