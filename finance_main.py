...
## 输出格式（纯JSON，不要其他内容）
{{
  "title": "文章标题（基于选题标题优化：如果原标题只是陈述事实，改成带'为什么''怎么做到的''凭什么'的悬念式标题，让读者必须点开才能得到答案）",
...
3. 数字是否真实可查？不能瞎编
4. 读者会不会觉得"这跟我有关"？好选题要么让人觉得自己也能用上（规律、方法、机会），要么直接戳中读者的处境（你的钱、你的工资、你的选择）。纯粹讲别人的故事而跟普通人无关的，不合格
