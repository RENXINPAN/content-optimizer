...
【封面文字】（15字以内）"""
    ...
    def _build_requirements(self, patterns: dict) -> str:
        ...
        scenes = [
            ...
            "在路边摊吃到一样让你愣住的东西",
            "自己做了一道菜，做的过程想起了一些事",
            "和朋友去了一家很贵的餐厅，但最好吃的反而是饭后路边买的烤红薯",
            "在夜市闻到一种味道，突然被拉回了某段记忆",
            "找到一家苍蝇馆子，老板的做法让你觉得这才是手艺",
            # 人
            "和一个当地人聊了几句，他的一句话让你记到现在",
            "在咖啡店遇到一个独自旅行的人，你们聊了一会儿",
            "约了一个很久没见的老朋友吃饭，发现彼此都变了",
            "出租车司机说了句特别现实的话",
            "旅店老板做了一件让你意外的小事",
            "后辈打电话来问你意见，你不知道该怎么回答",
            "她发了条朋友圈，你看了很久",
            "你妈打视频来，背景是你家厨房，你突然有点想回去",
            # 见闻
            "走进一条没人的小巷，看到一幕让你停下脚步的场景",
            "逛了一个当地的市场，发现一种你没见过的东西",
            "下雨了，你躲进一家店，意外发现这地方很有意思",
            "坐在路边看人来人往，观察到一个有趣的细节",
            "在一个寺庙/教堂/老建筑里坐了很久，什么都没想",
            # 物质与生活
            "买了一样贵的东西，用的时候想起以前买不起的自己",
            "住了一家很好的酒店，但让你最开心的是一个很小的细节",
            "戴着好表蹲在路边吃面，旁边大爷看了你一眼",
            "翻出一件旧东西，想起买它时的心情和现在完全不同了",
            "在免税店逛了一圈，什么都没买，但想了很多",
            # 情绪
            "半夜睡不着，算了一笔账",
            "刷到老同学的朋友圈，他过得比你好太多了",
            "一个比你年轻的人做成了你想做的事，你心情复杂",
            "有人说你活得自由，你笑了笑，但心里不是滋味",
            "你发现自己越来越像当初不想成为的那种人",
            "突然很想回到某个已经回不去的地方",
            # 感悟
            "走了很多路，突然觉得'够了'这两个字很舒服",
            "放弃了一件坚持很久的事，反而轻松了",
            "听到一首老歌，停在路边站了很久",
            "收到一条消息，是那种你不知道该不该回的",
            "某个瞬间突然觉得，现在的生活挺好的",
        ...
        locations = [
            # 国内
            "大理古城", "成都玉林路", "厦门沙坡尾", "长沙坡子街",
            "重庆十八梯", "西安回民街", "潮汕某个小镇", "景德镇",
            "泉州老城", "昆明翠湖边", "杭州馒头山", "苏州平江路",
            "广州老西关", "深圳城中村", "北京胡同", "上海弄堂",
            "贵阳", "柳州", "顺德", "汕头",
            # 东南亚
            "清迈古城", "曼谷唐人街", "吉隆坡茨厂街", "西贡（胡志明市）",
            "巴厘岛乌布", "槟城乔治市", "万象湄公河边", "仰光",
            # 日韩港澳
            "京都�的小巷", "东京下北泽", "首尔延南洞",
            "香港深水埗", "澳门老城区",
            # 欧洲
            ...
            "伊斯坦布尔大巴扎",
            # 模糊
            "南方某个不知名的小城", "北方一个灰扑扑的老城",
            "一个靠海的小镇", "一个山里的县城",
        ]

        picked_scene = random.choice(scenes)
        picked_location = random.choice(locations)

        return f"""今天的写作灵感（可以自由发挥，不强制）：
场景：{picked_scene}
地点：{picked_location}
